...
export default function Motion() {
  useEffect(() => initMotion({"hero": ".hero-content .eyebrow, .hero h1, .hero-copy, .hero-actions", "art": ".hero-media, .review-symbol", "reveal": ".intro-copy h2, .spice-line span, .section-heading h2, .format-card, .review-section h2, .visit-copy h2", "artStart": "scale(1.05)"}), []);
  return null;
}
